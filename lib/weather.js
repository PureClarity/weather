...
Weather.Forecast.prototype.low = function () {
  if (!this.data || !this.data.list || this.data.list.length === 0) return;
...
Weather.Current.prototype.temperature = function () {
  return this.data && this.data.list ? this.data.list[0].main.temp : null;
};

Weather.Current.prototype.minTemperature = function () {
  return this.data && this.data.list ? this.data.list[0].main.temp_min : null;
};

Weather.Current.prototype.maxTemperature = function () {
  return this.data && this.data.list ? this.data.list[0].main.temp_max : null;
};

Weather.Current.prototype.pressure = function () {
  return this.data && this.data.list ? this.data.list[0].main.pressure : null;
};

Weather.Current.prototype.humidity = function () {
  return this.data && this.data.list ? this.data.list[0].main.humidity : null;
};

Weather.Current.prototype.conditions = function () {
  var conditions = this.data && this.data.list ? this.data.list[0].weather : [];
  return conditions;
};
